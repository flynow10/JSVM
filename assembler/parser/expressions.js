...
import { interpretAs } from "./interpret-as.js";

const expressionElement = A.choice([hexLiteral, variable, interpretAs]);
...
const typifyBracketedExpr = (expr) => {
  return T.bracketedExpression(
    expr.map((element) => {
      if (Array.isArray(element)) {
        return typifyBracketedExpr(element);
      }
      return element;
    })
  );
